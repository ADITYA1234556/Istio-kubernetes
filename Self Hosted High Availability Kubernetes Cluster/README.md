...
1. **Initialize the first master node:**
   ...
   sudo kubeadm init --control-plane-endpoint "35.178.174.121:6443" --upload-certs --pod-network-cidr=10.244.0.0/16
   ```
...
**HAPROXY UI** <img src="../haproxy.png"> 